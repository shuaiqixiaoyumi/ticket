...
<div class="wrap-content-dialog m-n5">
  <div class="auth-config-dialog-list panel">
	   <div class="panel-search">
	      <form class="form-inline" id="search-form-role" method="post" role="form" action="flowrole/addUser" target=".bootstrap-dialog-message">
			 ...
			 <div class="right p-r-5">
			   <button type="button" class="btn btn-sm btn-success cnoj-auth-config-submit" data-uri="flowrole/saveUser.json"  data-config-id="${searchParam.id}" data-alert-msg="请选择要添加的用户！" data-refresh-uri="flowrole/userlist?id=${searchParam.id}" data-refresh-target="#flowrole-user-tab" > &nbsp;<i class="glyphicon glyphicon-ok-sign"></i> 确定 &nbsp;</button>
		     </div>
          </form>
	   </div><!-- panel-search -->
