...
public class OrgDao extends BaseDaoImpl<TNOrg> implements IOrgDao {
	...
	public TNOrg getDeptIdByName(String dept, String parentId) {
		TNOrg org = null;
		String sql = sqlMap.getSQL("get_org_by_name_and_parentid");
		if(StringUtils.isEmpty(sql)) {
			return org;
		}
		Map<String, Object> params = new HashMap<String, Object>();
	...
	@SuppressWarnings("unused")
	public TNOrg getSupportDeptIdByOrgName(String dept) {
		TNOrg org = null;
		String sql = sqlMap.getSQL("get_org_by_name_support");
		if(StringUtils.isEmpty(sql)) {
			return org;
		}
		Map<String, Object> params = new HashMap<String, Object>();
