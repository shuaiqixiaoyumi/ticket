...
import cn.com.smart.web.bean.DocSubmitDataBean;
...
public class RoleController extends BaseController {
	...
	public @ResponseBody SmartResponse<String> add(HttpSession session,TNRole role,
			String[] menuId,String[] docId, SubmitDataBean submitBean,DocSubmitDataBean docSubmitBean) throws Exception {
		SmartResponse<String> smartResp = new SmartResponse<String>();
		if(null != role) {
			role.setUserId(getUserInfoFromSession(session).getId());
			smartResp = roleServ.save(role,menuId,(null != submitBean ? submitBean.getTreeProps():null), (null != docSubmitBean ? docSubmitBean.getTreePropsDoc():null), docId);
		}
		return smartResp;
	}
	
	@RequestMapping(value="/edit",method=RequestMethod.POST)
	public @ResponseBody SmartResponse<String> edit(TNRole role,String[] menuId,SubmitDataBean submitBean,DocSubmitDataBean docSubmitBean, String[] docId) throws Exception {
		SmartResponse<String> smartResp = new SmartResponse<String>();
		if(null != role) {
			smartResp = roleServ.update(role,menuId,(null != submitBean ? submitBean.getTreeProps():null),(null != docSubmitBean ? docSubmitBean.getTreePropsDoc():null), docId);
		}
		return smartResp;
	}
