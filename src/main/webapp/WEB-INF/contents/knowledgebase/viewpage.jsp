...
<script type="text/javascript" src="${APP_PATH}/js/knowledgebase/viewpage.js"></script>
...
        <textarea  id="copyurl" style="float:left;z-index: 99;position: absolute;width:5px;height:2px"  readonly value="" />
</div>
...
<div id="wrap-content">
	...
	<header>
		<center>
		<p id="titleName" class="art-title">加载中。。。</p>
		<p id="remark">文章概况:</p>		
		</center>
	</header>
