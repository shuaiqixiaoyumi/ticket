...
public class FormService extends MgrServiceImpl<TForm> implements IFormService {
	...
	public List<Object> findFormInfoByFormId(String formId){
		Map<String,Object> param = new HashMap<String, Object>(1);
		param.put("formId", formId);
		String sql = SQLResUtil.getOpSqlMap().getSQL("get_formfile_byformid");
		if(StringUtils.isNotEmpty(sql)) {
			List<Object> lists = getDao().queryObjSql(sql, param);
