...
<div class="wrap-content">
    <div class="panel no-border">
        <div class="panel-search">
              <form class="form-inline cnoj-entry-submit" id="search-form-flowuser" method="post" role="form" action="user/flowrolelist" target="#user-flowrole-tab">
		...
		<cnoj:table smartResp="${smartResp }" headers="名称,英文名称,描述" isCheckbox="1" isRowSelected="1" page="${pageParam }" currentUri="${currentUri }" 
