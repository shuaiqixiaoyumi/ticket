...
<div class="wrap-content">
    <div class="panel no-border">
        <div class="panel-search">
              <form class="form-inline cnoj-entry-submit" id="search-form-user" method="post" role="form" action="flowrole/userlist" target="#flowrole-user-tab">
		...
		<cnoj:table smartResp="${smartResp }" headers="用户名,姓名,联系电话,所属部门,排序" isCheckbox="1" isRowSelected="1" page="${pageParam }" currentUri="${currentUri }" 
