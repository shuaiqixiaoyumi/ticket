	   ...
	   <div class="panel-tabs-wrap" id="has-role-content">
			<div class="panel-tabs-tab">
				<ul class="nav nav-tabs" role="tablist">
				   <li class="active"><a href="#flowrole-user-tab" role="presentation" data-toggle="tab"> 用户列表</a></li>
				</ul>
		  	</div>
		  	<div class="tab-content panel-tab-content bg-color-white p-0 cnoj-auto-limit-height">
				<div role="tabpanel" class="tab-pane active" id="flowrole-user-tab">
				    <div class="cnoj-load-url" data-uri="flowrole/userlist?id=${id }" ></div>
				</div>
			</div>
		</div>
	</div>
