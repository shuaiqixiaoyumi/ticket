...
<div class="wrap-content">
    <div class="panel no-border">
        <div class="panel-search borer-bottom">
              <form class="form-inline cnoj-entry-submit" id="search-form-role" method="post" role="form" action="flowrole/simplist" target="#flowrole-tab">
		...
		<cnoj:tableItem smartResp="${smartResp }" headers="名称,英文名,描述" isRowSelected="1" currentUri="${currentUri }" 
