 ...
 * 
 */
function panelDocTreeListener($elementWrap) {
	var uri = 'doc/tree';
	if(utils.isEmpty($elementWrap) || !utils.isExist($elementWrap)) {
		$(".cnoj-panel-doc-tree").each(function(){
			_handler($(this));
		});
	} else {
		$elementWrap.find(".cnoj-panel-doc-tree").each(function(){
			_handler($(this));
		});
	}
	 ...
	 */
	function _handler($element) {
		if(!$element.hasClass("cnoj-panel-doc-tree-listener")) {
			$element.addClass("cnoj-panel-doc-tree-listener");
			var redirectUri = $element.data("redirect-uri");
			var target = $element.data("target");
			var isSearch = $element.data("is-search");
			isSearch = utils.isEmpty(isSearch)?false:(isSearch=='yes'?true:false);
...
function initEvent($elementWrap) {
	...
	panelDocTreeListener($elementWrap);
